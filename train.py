...
def main(args):
    ...
    if args.restart > 0:
        log(f'Restarting from epoch {args.restart}')
        model_to_load = os.path.join(args.exp_dir, f'model_{args.restart}.pt')
        opt_to_load = os.path.join(args.exp_dir, f'optimizer_{args.restart}.pt')
...
if __name__ == '__main__':
    ...
    # config_filename = 'configs.' + args.config_name
