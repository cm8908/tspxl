"""
Supervised Learning, Sequence to sequence loss
"""
import os, shutil
import time
import torch
...
if args.n_point >= 50:
    ...
    train_set = TSPDataset(n=args.n_point, mode='train', root_dir=args.data_root, author=args.data_source, device=device)
    val_set = TSPDataset(n=args.n_point, mode='val', root_dir=args.data_root, author=args.data_source, device=device)
    test_set = TSPDataset(n=args.n_point, mode='test', root_dir=args.data_root, author=args.data_source, device=device)
